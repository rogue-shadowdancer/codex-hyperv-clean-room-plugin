...
$requiredPhrases = [ordered]@{
    ...
    'TASK_HANDOFF.md' = @('relayProtocolVersion', 'validate-gate7.ps1', 'H3/G8', 'notPerformed')
    ...
    'docs\specification.md' = @('Plugin 0.2.0 and schema-v2 target contract', 'plan_vm_power', 'plan_vm_network', 'portable-manifest.json', 'data-testid', 'UNSUPPORTED_SCHEMA_VERSION', 'Gate 6/H1 acceptance boundary')
