...
$requiredPhrases = [ordered]@{
    ...
    'README.md' = @('v0.1.1', 'GPL-3.0-only', '16 MCP tools', '0.2.0', 'notPerformed')
    'TASK_HANDOFF.md' = @('nextCommands[]', 'validate-gate6.ps1', 'Gate 7/H2', 'notPerformed')
    'docs\architecture.md' = @('PowerShell Direct', 'trust boundar', 'operation-scoped', '16', 'Schema-v2 target architecture', 'paired recovery')
