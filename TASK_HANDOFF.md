...
- `git diff --check`
- Five Codex review passes found ten actionable fail-closed gaps: external ZIP
  ...
  manifest runtime/packaging provenance. All ten are repaired with direct
  regression probes; the final published candidate requires a fresh
