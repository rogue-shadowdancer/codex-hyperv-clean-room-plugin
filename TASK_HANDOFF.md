...
- `git diff --check`
- Six Codex review passes found eleven actionable fail-closed gaps: external ZIP
  ...
  manifest runtime/packaging provenance and Windows-safe ZIP-leaf enforcement.
  All eleven are repaired with direct regression probes; the final published
