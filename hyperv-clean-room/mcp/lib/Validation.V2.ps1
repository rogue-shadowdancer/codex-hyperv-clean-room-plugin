...
function Test-HcrEvidenceDocumentV2 {
    ...
    if ($externalPortable) {
        ...
        $pluginBaseVersion = [string](Get-HcrPropertyValue $runtime 'pluginBaseVersion')
        ...
        $compatibleExternalVersion = (
            ...
            ($pluginBaseVersion -eq '0.4.0' -and
                $pluginBuildVersion -match '^0\.4\.0\+codex\.[0-9]{14}$') -or
            ($pluginBaseVersion -eq '0.4.1' -and
                $pluginBuildVersion -match '^0\.4\.1\+codex\.[0-9]{14}$')
        )
