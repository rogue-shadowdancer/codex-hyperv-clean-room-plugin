...
### Status: released 0.2.0 source; installation validation pending
...
hosted CI plus authenticated and anonymous readback. Cachebuster/personal
installation, installed-source match, and real VM, guest, package, portable,
WebDriver, network, UI, manual, and clean-machine operations remain
`notPerformed`.
...
[`v0.2.0`](https://github.com/rogue-shadowdancer/codex-hyperv-clean-room-plugin/releases/tag/v0.2.0)
tag 与 GitHub Release，并通过 hosted CI、认证及匿名读回。cachebuster/personal
安装、installed-source match，以及真实 VM、guest、package、portable、WebDriver、
network、UI、manual 与 clean-machine operation 仍为 `notPerformed`。
